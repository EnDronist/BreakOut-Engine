...
Vec2 Mouse::GetPos() const {
	double x_game = (double)x / Settings::SizeMultiplierX();
	double y_game = (double)y / Settings::SizeMultiplierY();
	return Vec2{ x_game, y_game };
}
Vec2 Mouse::GetScreenPos() const {
	return Vec2{ (double)x, (double)y };
}
int Mouse::GetX() const {
	int x_game = (int)((double)x / Settings::SizeMultiplierX());
	return x_game;
}
int Mouse::GetY() const {
	int y_game = (int)((double)y / Settings::SizeMultiplierY());
	return y_game;
}
